      ...
      <div className="row mb-5">
        ...
        <div className="col-lg-3 col-md-6 mb-5 mb-md-5">
          <div className="ftco-footer-widget mb-4">
            ...
            <ul>
                  <li><span className="icon icon-map-marker"></span><span className="text">203 Fake St. Hail South</span></li>
                  <li><a href="#"><span className="icon icon-phone"></span><span className="text">24 3772</span></a></li>
        ...
        <div className="row">
          <div className="col-md-12 text-center">
            <p>
              {/* The script tag for dynamically setting the year has been replaced with a direct JavaScript expression */}
              Copyright &copy;{currentYear} All rights reserved | This template is made with <i className="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" rel="noopener noreferrer">Colorlib</a>
            </p>
          </div>
        </div>
      </div>
